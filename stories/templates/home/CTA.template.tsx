...
export const CTA = () => {
  ...
  const handleEmojiPlayer = (eve: PlayerEvent) => {
    ...
    if (eve === PlayerEvent.Frame) {
      ...
      if (talkEmojiRef.current?.state.playerState === PlayerState.Playing)
        return;
    }
  };
    ...
    <View h="h-screen" className="ctagradient">
      ...
      >
        ...
        >
          ...
          based in India whose job primarily involves bridging the gap between
          design and code or maybe writing server-side logic. Apart from
          Engineering, there is a baller side which cries over,{" "}
          <Text
            as="span"
            color="text-gray-500"
            fontWeight="font-medium"
