    ...
    <View h="h-screen" className="ctagradient">
      ...
      >
        ...
        >
          ...
          based in Bengaluru, Karnataka whose job primarily involves bridging
          the gap between design and code or maybe writing server-side logic. My
          baller side also cries over,{" "}
          <Text
            as="span"
            color="text-gray-500"
            fontWeight="font-medium"
